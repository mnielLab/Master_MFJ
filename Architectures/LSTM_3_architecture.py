...
class CDR3b_BiLSTM(nn.Module):
    def __init__(self, max_length = 24, hidden_size = 64, dropout_rate = 0.5):
        ...
        self.linear = nn.Linear(in_features = max_length*3*2*2,
    ...
    def forward(self, pep, cdr3b):
        ...
        BiLSTM_pep_2 = self.BiLSTM(pep)
        BiLSTM_cdr3b_2 = self.BiLSTM(cdr3b)
        
        BiLSTM_pep_3 = self.BiLSTM(pep)
        BiLSTM_cdr3b_3 = self.BiLSTM(cdr3b)
...
class CDR3_BiLSTM(nn.Module):
    def __init__(self, max_length = 24, hidden_size = 64, dropout_rate = 0.5):
        ...
        self.linear = nn.Linear(in_features = max_length*3*3*2,
                                out_features = hidden_size)
    ...
    def forward(self, pep, cdr3a, cdr3b):
        ...
        BiLSTM_pep_2 = self.BiLSTM(pep)
        BiLSTM_cdr3a_2 = self.BiLSTM(cdr3a)
        BiLSTM_cdr3b_2 = self.BiLSTM(cdr3b)
        
        BiLSTM_pep_3 = self.BiLSTM(pep)
        BiLSTM_cdr3a_3 = self.BiLSTM(cdr3a)
        BiLSTM_cdr3b_3 = self.BiLSTM(cdr3b)
...
class CDR123_BiLSTM(nn.Module):
    def __init__(self, max_length = 24, hidden_size = 64, dropout_rate = 0.5):
        ...
        self.linear = nn.Linear(in_features = max_length*7*3*2,
                                out_features = hidden_size)
    ...
    def forward(self, pep, cdr1a, cdr2a, cdr3a, cdr1b, cdr2b, cdr3b):
        ...
        BiLSTM_pep_2 = self.BiLSTM(pep)
        BiLSTM_cdr1a_2 = self.BiLSTM(cdr1a)
        BiLSTM_cdr2a_2 = self.BiLSTM(cdr2a)
        BiLSTM_cdr3a_2 = self.BiLSTM(cdr3a)
        BiLSTM_cdr1b_2 = self.BiLSTM(cdr1b)
        BiLSTM_cdr2b_2 = self.BiLSTM(cdr2b)
        BiLSTM_cdr3b_2 = self.BiLSTM(cdr3b)
        
        BiLSTM_pep_3 = self.BiLSTM(pep)
        BiLSTM_cdr1a_3 = self.BiLSTM(cdr1a)
        BiLSTM_cdr2a_3 = self.BiLSTM(cdr2a)
        BiLSTM_cdr3a_3 = self.BiLSTM(cdr3a)
        BiLSTM_cdr1b_3 = self.BiLSTM(cdr1b)
        BiLSTM_cdr2b_3 = self.BiLSTM(cdr2b)
        BiLSTM_cdr3b_3 = self.BiLSTM(cdr3b)
    
        cat = torch.cat([BiLSTM_pep, 
                         BiLSTM_cdr1a, BiLSTM_cdr2a, BiLSTM_cdr3a, 
                         BiLSTM_cdr1b, BiLSTM_cdr2b, BiLSTM_cdr3b,
                         BiLSTM_pep_2, 
                         BiLSTM_cdr1a_2, BiLSTM_cdr2a_2, BiLSTM_cdr3a_2, 
                         BiLSTM_cdr1b_2, BiLSTM_cdr2b_2, BiLSTM_cdr3b_2,
                         BiLSTM_pep_3, 
                         BiLSTM_cdr1a_3, BiLSTM_cdr2a_3, BiLSTM_cdr3a_3, 
                         BiLSTM_cdr1b_3, BiLSTM_cdr2b_3, BiLSTM_cdr3b_3], 2)
